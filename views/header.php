    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a id="btn-new-question-a" class="nav-link" href="index.php?action=newQuestion"><button id="btn-new-question" class="btn btn-light" type="button">New Question</button></a>
                </li>
            </ul>
        </div>
    </div>
